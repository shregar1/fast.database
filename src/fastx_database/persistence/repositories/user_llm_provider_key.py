...
Usage:
    >>> from fastx_database.persistence.repositories.user_llm_provider_key import UserLlmProviderKeyRepository
...
class UserLlmProviderKeyRepository(IRepository):
    """CRUD for :class:`~fastx_database.persistence.models.user_provider_key.UserProviderKey`."""
