...
:class:`~fastx_database.persistence.repositories.repository.IRepository`. Get by user and type, list all consents for a user, and accept
(upsert: update version and accepted_at if record exists, else create). Used
by registration and legal-compliance flows.

Usage:
    >>> from fastx_database.persistence.repositories.consent import ConsentRepository
...
from fastx_database.persistence.models.consent import ConsentRecord
