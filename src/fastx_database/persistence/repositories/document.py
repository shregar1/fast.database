...
:class:`~fastx_database.persistence.repositories.repository.IRepository` with ``model=Document``.

Usage:
    >>> from fastx_database.persistence.repositories.document import DocumentRepository
...
from fastx_database.persistence.models.document import Document
