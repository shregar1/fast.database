...
``fastx_database.persistence.repositories.filter_operator.FilterOperator``.
...
# Import ContextMixin from fastx_platform to eliminate duplication
...
class IRepository(ContextMixin):
    ...
    Note:
        ...
        ``fastx_database.persistence.repositories.filter_operator.FilterOperator`` for operator
