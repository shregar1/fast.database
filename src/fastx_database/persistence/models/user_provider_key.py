...
from fastx_database.core.constants.db import ServerDefault, StringLength
...
class UserProviderKey(Base):
    ...
    provider = Column(String(StringLength.STATUS), nullable=False)
    secret_ciphertext = Column(Text, nullable=False)
    is_encrypted_by_client = Column(Boolean, nullable=False, server_default=ServerDefault.FALSE)
