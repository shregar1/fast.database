...
class Cart(Base):
    ...
    guest_token = Column(String(StringLength.URN), nullable=True, index=True)
    ...
    coupon_code = Column(String(StringLength.CODE), nullable=True, index=True)
...
class CartItem(Base):
    ...
    notes = Column(String(StringLength.LONG_TEXT), nullable=True)
