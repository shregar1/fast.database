...
from fastx_database.core.constants.db import DEFAULT_ATTEMPTS, StringLength
...
class Webhook(Base):
    ...
    url = Column(String(StringLength.LONG_TEXT), nullable=False)
    secret = Column(String(StringLength.PASSWORD), nullable=False)
    description = Column(String(StringLength.DESCRIPTION), nullable=True)
...
class WebhookDelivery(Base):
    ...
    event_id = Column(String(StringLength.URN), nullable=False, index=True)
    event_type = Column(String(StringLength.URN), nullable=False, index=True)
    payload = Column(JSON, nullable=True)

    status = Column(String(StringLength.STATUS), nullable=False, default=Status.PENDING, index=True)
    attempts = Column(Integer, nullable=False, default=DEFAULT_ATTEMPTS)

    response_code = Column(Integer, nullable=True)
    error_message = Column(String(StringLength.DESCRIPTION), nullable=True)
