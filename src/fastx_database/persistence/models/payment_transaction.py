...
class PaymentTransaction(Base):
    ...
    provider_payment_id = Column(String(StringLength.URN), nullable=True, index=True)
    provider_customer_id = Column(String(StringLength.URN), nullable=True, index=True)
    provider_payment_method_id = Column(String(StringLength.URN), nullable=True)
    failure_code = Column(String(StringLength.CODE), nullable=True)
    failure_message = Column(String(StringLength.DESCRIPTION), nullable=True)
