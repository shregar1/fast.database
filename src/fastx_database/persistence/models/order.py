...
class Order(Base):
    ...
    order_number = Column(String(StringLength.CODE), nullable=False, index=True)
    ...
    email = Column(String(StringLength.EMAIL), nullable=False)
    customer_note = Column(Text, nullable=True)
    payment_status = Column(String(StringLength.STATUS), nullable=False, default=Status.PENDING, index=True)
    ...
    cancel_reason = Column(String(StringLength.DESCRIPTION), nullable=True)
    external_order_id = Column(String(StringLength.URN), nullable=True, index=True)
...
class OrderItem(Base):
    ...
    sku = Column(String(StringLength.URN), nullable=True, index=True)
    title = Column(String(StringLength.DESCRIPTION), nullable=False)
    variant_title = Column(String(StringLength.NAME), nullable=True)
    ...
    fulfillment_status = Column(
        String(StringLength.STATUS), nullable=False, default=Status.PENDING, index=True
    )
